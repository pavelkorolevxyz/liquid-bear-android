...
public class LastfmRadiomixActivity extends ListBaseActivity {
    ...
    public static Intent startIntent(Context context) {
        return new Intent(context, LastfmRadiomixActivity.class);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getResources().getString(R.string.radiomix));
        getLibraryTracks();
    }
    ...
    private void getLibraryTracks() {
        libraryModel.getRadiomix(authManager.getLastfmName(), new SimpleCallback<List<LastfmTrack>>() {
                    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemId) {
            case R.id.to_playlist: {
                ...
                Toast.makeText(LastfmRadiomixActivity.this, R.string.added, Toast.LENGTH_SHORT).show();
            }
            return true;
